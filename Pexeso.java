    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        while (karticky > 0) {
            ...
            if (input != input1) {
                ...
                System.out.print(ConsoleColors.RED_BRIGHT + "5" + ConsoleColors.RESET);
                System.out.print("\r");
                Thread.sleep(1000);
                System.out.print(ConsoleColors.RED_BRIGHT + "4" + ConsoleColors.RESET);
                Thread.sleep(1000);
                System.out.print("\r");
                System.out.print(ConsoleColors.RED_BRIGHT + "3" + ConsoleColors.RESET);
                Thread.sleep(1000);
                System.out.print("\r");
                System.out.print(ConsoleColors.RED_BRIGHT + "2" + ConsoleColors.RESET);
                Thread.sleep(1000);
                System.out.print("\r");
                System.out.print(ConsoleColors.RED_BRIGHT + "1" + ConsoleColors.RESET);
                Thread.sleep(1000);
                pole[radek][sloupec] = "❓";
                ...
                System.out.println();
                System.out.println(ConsoleColors.GREEN_BRIGHT + "Hezky !!! Nasel jsi par" + ConsoleColors.RESET);
                System.out.println();
                karticky--;
            }
        ...
        System.out.println(ConsoleColors.GREEN_BRIGHT + "Gratuluji dohral jsi pexeso" + ANSI_RESET);
    }
